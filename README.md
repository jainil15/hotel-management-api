...
```
cd existing_repo
git remote add origin https://gitlab.com/Ajaypanduri/onelyk-nodejs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Ajaypanduri/onelyk-nodejs/-/settings/integrations)
