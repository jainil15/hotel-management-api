    ...
    for(const event of events) {
      switch(event){
        ...
        case "reservation_status_changed":
            result.push(await hotelKeyPmsHandler.updateReservationStatus(payload,propertyId,req));
            break;
        case "guest_data_changed":
            result.push(await hotelKeyPmsHandler.updateReservationGuest(payload,propertyId,req));
            break;
        case "reservation_checked_in":
            result.push(await hotelKeyPmsHandler.reservationCheckedIn(payload,propertyId,req));
            break;
        case "reservation_checked_out":
            result.push(await hotelKeyPmsHandler.reservationCheckedOut(payload,propertyId,req));
            break;
        case "reservation_cancelled":
            result.push(await hotelKeyPmsHandler.reservationCancelled(payload,propertyId,req));
            break;
        case "check_out_date_extended":
            result.push(await hotelKeyPmsHandler.checkOutDateExtended(payload,propertyId,req));
            break;
        case "additional_guest_data_changed":
            result.push(await hotelKeyPmsHandler.additionalGuestDataChanged(payload,propertyId,req));
            break;
        case "arrival_time_changed":
            result.push(await hotelKeyPmsHandler.arrivalTimeChanged(payload,propertyId,req));
            break;
